    ...
    <div className="bg-white dark:bg-gray-900 text-gray-900 dark:text-white min-h-screen">
      ...
      <section className="text-center p-8 relative">
        ...
        <h1 className="text-4xl md:text-6xl font-bold text-orange-400 relative z-10">
          Revolutionize Supply Chain Tracking with SuiviClair
        </h1>
        <p className="text-gray-300 mt-4 max-w-3xl mx-auto relative z-10">
          Experience real-time transparency, trust, and efficiency with advanced 
          shipment tracking. From manufacturing to delivery, every step is carefully 
      ...
      <section className="bg-gray-800 p-8 text-center">
        ...
        <p className="text-gray-400 mb-8">
          Discover how SuiviClair revolutionizes supply chain tracking with cutting-edge 
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div className="p-4 bg-gray-700 rounded">
            ...
            <p className="text-gray-400 mt-2">
              Each step in the process is securely logged, providing a reliable record.
            </p>
          </div>
          <div className="p-4 bg-gray-700 rounded">
          ...
          <div className="p-4 bg-gray-700 rounded">
            ...
            <p className="text-gray-400 mt-2">
              Resolve disputes quickly with accurate and verifiable data.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="p-8">
        ...
        <p className="text-center text-gray-400 mb-8">
          Track every step of your shipment's journey with SuiviClair, offering a seamless 
